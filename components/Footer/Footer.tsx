        ...
        <S.Wrapper>
            <S.Container>
                <S.Top>
                    <S.Brand>
                        <S.BrandLogo>
                            <Image src="/logo.png" alt={t('"Mandrivna Kramnytsya"')} fill priority />
                        </S.BrandLogo>
                        <S.BrandText>
                            {t('The "Mandrivna Kramnytsya" is a space where gastronomy, history, and the spirit of travel meet. We revive the atmosphere of ancient Podil — a place where international trade routes intersected — so you can feel like a traveler of ancient times and get a unique shopping experience.')}
                        </S.BrandText>
                    </S.Brand>
                    ...
                    <S.PolicyModalContainer onClick={(e) => e.stopPropagation()}>
                        ...
                        <S.PolicyScrollArea>
                            <S.PolicySection>
                                ...
                                <S.PolicyText>
                                    {t('This Privacy Policy determines the procedure for collecting, storing, processing, and using the personal data of users of the "Mandrivna Kramnytsya" website and web application.')}
                                    <br /><br />
                                    {t("We comply with GDPR requirements and principles — transparency, security, and data minimization. By using our site, creating an account, and registering in the Hermes loyalty program, you confirm that you have read and agree to this Policy.")}
                                </S.PolicyText>
                            </S.PolicySection>

                            <S.PolicySection>
                                <S.PolicySectionTitle>{t("2. What data we collect")}</S.PolicySectionTitle>
                                <S.PolicyText>{t("We collect only the data necessary for the operation of the service and the loyalty program:")}</S.PolicyText>
                                <S.PolicyList>
                            ...
                            <S.PolicySection>
                                ...
                                <S.PolicyText>
                                    {t("Our site uses strictly necessary cookies that ensure the proper operation of the service and authorization. We do not use advertising or analytical cookies unless you explicitly agree to them.")}
                                    <br /><br />
                                    {t("Necessary cookies ensure the operation of the site and cannot be disabled. These include session cookies (store temporary technical data — your session identifier) and a refresh token cookie used to extend your authorized session without re-entering the SMS code. This cookie is secure and inaccessible to third-party sites.")}
                                </S.PolicyText>
                            </S.PolicySection>
                            ...
                            <S.PolicySection>
                                ...
                                <S.PolicyText>{t("We do not transfer your data to third parties, except when necessary for the operation of technological services (SMS sending, simplified admin panel) and only via a secure protocol.")}</S.PolicyText>
                            </S.PolicySection>
                        </S.PolicyScrollArea>
