                    ...
                    {Object.entries(positions).map(([_, position]) => {
                        ...
                        return (
                            <CartItem key={position.product.id}>
                                ...
                                <ItemPrice>
                                    <strong>{formatPrice(position.product.price)} {t("UAH")}</strong>
                                </ItemPrice>
        ...
        <RightColumn>
            <SummaryBlock>
                ...
                <SummaryRow>
                    ...
                    <span>{formatPrice(subtotal)} {t("UAH")}</span>
                </SummaryRow>
                <SummaryRow>
                ...
                <SummaryRow>
                    ...
                    <span>-{formatPrice(redeemedMilesValue)} {t("UAH")}</span>
                </SummaryRow>
                <TotalRow>
                    <span>{t("Total:")}</span>
            ...
            <SummaryBlock>
                ...
                <TotalRow>
                    <span>{t("Total:")}</span>
                    <span>+{orderMilesReward + newCountriesReward} {t("miles")}</span>
                </TotalRow>
            </SummaryBlock>
